...
static void ArduinoMailbox::Initialize()
{
    ...
    Serial.println("Launching Mailbox main task");
...
{
    Serial.println("RX task launched");
...
{
    Serial.println("TX task launched");
...
int ArduinoMailbox::RX_USB(Letter_T & lLetter)
{
    ...
    lLetter.sMessage = string(cData[2]);
